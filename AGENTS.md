...
+ default test model: set LLAMACPP_TEST_MODELFILE=/models/Qwen_Qwen3-1.7B-Q8_0.gguf when running tests
+ use cpu/CUDA to run, example
./build-cpu/bin/llama-cli -m /models/Qwen_Qwen3-1.7B-Q8_0.gguf -p "Hello, I come from US, where are you come from ?" -n 8 --temp 1.0 --seed 1 -st 
GGML_CUDA=ON ./build/bin/llama-cli -m /models/Qwen_Qwen3-1.7B-Q8_0.gguf -p "Hello, I come from US, where are you come from ?" -n 8 --temp 1.0 --seed 1 -st 
